...
if [ $1 = "start" ]; then
    ...
    echo -e '\033[31;5;7m[  WARN  ] \033[0m' "hostname :  https://$APPHOSTNAME/dashboards" > /dev/ttyS0
    echo -e '\033[31;5;7m[  WARN  ] \033[0m' "user : admin" > /dev/ttyS0
    echo -e '\033[31;5;7m[  WARN  ] \033[0m' "pass : $ADMIN_PASSWORD" > /dev/ttyS0
